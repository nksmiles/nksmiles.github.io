...
```
=IF(H9=0,"零元整",
IF(INT(H9/10000000)>0,CHOOSE(INT(H9/10000000)+1,"","壹","贰","叁","肆","伍","陆","柒","捌","玖")&"仟","")&
IF(INT(MOD(H9,10000000)/1000000)>0,CHOOSE(INT(MOD(H9,10000000)/1000000)+1,"","壹","贰","叁","肆","伍","陆","柒","捌","玖")&"佰","")&
IF(INT(MOD(H9,1000000)/100000)>0,CHOOSE(INT(MOD(H9,1000000)/100000)+1,"","壹","贰","叁","肆","伍","陆","柒","捌","玖")&"拾","")&
IF(INT(MOD(H9,100000)/10000)>0,CHOOSE(INT(MOD(H9,100000)/10000)+1,"","壹","贰","叁","肆","伍","陆","柒","捌","玖")&"万","")&
IF(INT(MOD(H9,10000)/1000)>0,CHOOSE(INT(MOD(H9,10000)/1000)+1,"","壹","贰","叁","肆","伍","陆","柒","捌","玖")&"仟","")&
IF(INT(MOD(H9,1000)/100)>0,CHOOSE(INT(MOD(H9,1000)/100)+1,"","壹","贰","叁","肆","伍","陆","柒","捌","玖")&"佰","")&
IF(INT(MOD(H9,100)/10)>0,CHOOSE(INT(MOD(H9,100)/10)+1,"","壹","贰","叁","肆","伍","陆","柒","捌","玖")&"拾","")&
CHOOSE(MOD(H9,10)+1,"","壹","贰","叁","肆","伍","陆","柒","捌","玖")&"元"&
IF(MOD(H9*100,100)=0,"整",
IF(MOD(INT(H9*10),10)>0,CHOOSE(MOD(INT(H9*10),10)+1,"","壹","贰","叁","肆","伍","陆","柒","捌","玖")&"角","零")&
IF(MOD(INT(H9*100),10)>0,CHOOSE(MOD(INT(H9*100),10)+1,"","壹","贰","叁","肆","伍","陆","柒","捌","玖")&"分","")))
```

上述公式最大支持9999万（99,999,999.99），完全不依赖数字格式，避免系统格式变化（比如在英文操作系统中）导致公式失效。
目前基本一直在用这个公式。
